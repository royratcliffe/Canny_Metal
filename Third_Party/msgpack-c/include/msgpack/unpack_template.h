...
msgpack_unpack_func(msgpack_unpack_object, _data)(msgpack_unpack_struct(_context) * ctx) { return (ctx)->stack[0].obj; }
...
#define SWITCH_RANGE_END                                                                                               \
    ...
    do {
      ...
      case MSGPACK_CS_HEADER:
        ...
        case 0xd6: // fixext 4
        case 0xd7: // fixext 8
          again_fixed_trail_if_zero(MSGPACK_ACS_EXT_VALUE, (1 << (((unsigned int)*p) & 0x03)) + 1, _ext_zero);
        case 0xd8: // fixext 16
